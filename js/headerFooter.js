...
encabezadoBody.innerHTML = `<a class="navbar-brand" href="#">
    <img src="${rootPath}/images/cryptoMineLogo.png" alt="Logo">
</a>
...
<div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
            <a class="nav-link" href="${rootPath}/index.html">Inicio</a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="${rootPath}/pages/cotizadorPrincipal.html">Inversion Basica</a>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="${rootPath}/pages/cotizadorMaquinas.html">Propuesta de Maquinas</a>
                <a class="dropdown-item" href="${rootPath}/pages/ultimaCotizacion.html">UltimaCotizacion</a>
                <a class="dropdown-item" href="${rootPath}/pages/valoresIniciales.html">Configuracion Propiedades</a>
            </div>
        </li>
        <li class="nav-item">
